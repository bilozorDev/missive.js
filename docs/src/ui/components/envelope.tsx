...
export const Envelope: React.FC<SVGProps<SVGSVGElement> & { branded?: boolean }> = ({ branded = true, ...props }) => {
    /* we could be more fancy here */
    const defaultColor = {
        border: branded ? '#2D527C' : 'currentColor',
        body: branded ? '#cebef9' : '#cebef9',
    };
    return (
        <svg
        ...
        >
            <path
                ...
                d="M415.676,394.806H66.195C29.696,394.806,0,365.111,0,328.61V88.935
	...
	C430.712,388.071,423.979,394.806,415.676,394.806z"
            ...
            <path
                ...
                d="M256,237.006L496.963,88.934c0-25.448-20.63-46.077-46.077-46.077H61.113
	c-25.448,0.002-46.076,20.631-46.076,46.079L256,237.006L256,237.006z"
            />
            <g>
                <path
                    fill={defaultColor.border}
                    d="M256,252.043c-2.728,0-5.459-0.741-7.872-2.226L7.165,101.746C2.713,99.01,0,94.159,0,88.935
		...
		c-3.469-13.353-15.625-23.24-30.046-23.24H61.114C46.692,57.896,34.536,67.783,31.067,81.136z"
                ...
                <path
                    fill={defaultColor.border}
                    d="M396.085,445.1H122.701c-8.304,0-15.037-6.734-15.037-15.037c0-8.304,6.734-15.037,15.037-15.037
		h273.386c8.304,0,15.037,6.734,15.037,15.037C411.124,438.366,404.39,445.1,396.085,445.1z"
                />
            </g>
            <polygon fill={defaultColor.body} points="392.914,342.154 488.241,405.648 392.914,469.143 " />
            <path
                fill={defaultColor.border}
                d="M392.913,484.18c-2.433,0-4.872-0.591-7.098-1.782c-4.887-2.616-7.938-7.711-7.938-13.255V342.152
